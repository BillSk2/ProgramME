...
<html lang="en">
	...
	<!-- Fixed navbar -->
		...
		<div class="container">
			...
			<h3> Επιλέξτε Μαθήματα Κατεύθυνσης </h3>
			<br/>
			<form method ="POST" action="katController.jsp">
			<%
			int semestercount = 1;
			for (semestercount = 1; semestercount <=8 ; semestercount++){ %>
				...
				courses2 = cDAO.getCourses(2 ,semestercount);
			...
			<button type="submit" class="button" style="width:200px" formaction="katController.jsp" >Submit</button>
			</form>
		</div>	
			<br/>
